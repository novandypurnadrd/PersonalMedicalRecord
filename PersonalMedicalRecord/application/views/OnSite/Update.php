    ...
    <section>
      ...
      <div class="main-content">
        ...
        <div class="page-content">
          <div class="header">
            <h2><strong>Update</strong> Consultation Form</h2>
          ...
          <?php foreach ($OnSite as $onsite): ?>
            <?php foreach ($Patient as $patient): ?>
              ...
              <?php endif; ?>
            <?php endforeach; ?>
            <form class="form-horizontal" method="post" action="<?php echo base_url().'OnSite/Update/UpdateOnSite/'.$id ?>">
            <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input autocomplete="off" class="form-control form-white" id="Patient" name="Patient" required type="text" placeholder="" value="<?php echo $onsite->Patient ?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-sm-4 control-label">Nationality</label>
                            <div class="col-sm-8">
                              <input autocomplete="off" class="form-control form-white" id="Nationality" name="Nationality" required type="text" placeholder="" value="<?php echo $onsite->Nationality ?>">
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="panel-content bg-default">
                      <div class="row">
                        <div class="col-md-4">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input autocomplete="off" class="form-control form-white" id="Incident" name="Incident" required type="text" placeholder="" value="<?php echo $onsite->Incident ?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-sm-4 control-label">Consultation Type</label>
                            <div class="col-sm-8">
                              <input autocomplete="off" class="form-control form-white" id="Consultation" name="Consultation" required type="text" placeholder="" value="<?php echo $onsite->Consultation ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <div class="prepend-icon">
                                <input autocomplete="off" type="text" id="Date" name="Date" class="b-datepicker form-control form-white" required data-date-format="yyyy-mm-dd" value="<?php echo $onsite->Date ?>">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input autocomplete="off" class="form-control form-white" id="Staff" name="Staff" required type="text" placeholder="" value="<?php echo $onsite->Staff ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <div class="prepend-icon">
                                <input type="text" name="Time" class="timepicker form-control form-white" placeholder="Choose a time..." value="<?php echo $onsite->Time ?>">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input autocomplete="off" class="form-control form-white" id="Case" name="Case" required type="text" placeholder="" value="<?php echo $onsite->CaseType ?>">
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-4">
                          ...
                          <div class="form-group">
                            <div class="col-sm-12">
                              <textarea name="Subjective" id="Subjective" rows="5" class="form-control form-white" placeholder="" required><?php echo $onsite->Subjective ?></textarea>
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <div class="col-sm-12">
                              <textarea name="Plan" id="Plan" rows="5" class="form-control form-white" placeholder="" required><?php echo $onsite->Plan ?></textarea>
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <div class="col-sm-12">
                              <textarea name="Education" id="Education" rows="5" class="form-control form-white" placeholder="" required><?php echo $onsite->Education ?></textarea>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-4">
                          ...
                          <div class="form-group">
                            <div class="col-sm-12">
                              <textarea name="Objective" id="Objective" rows="5" class="form-control form-white" placeholder="" required><?php echo $onsite->Objective ?></textarea>
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input autocomplete="off" class="form-control form-white" id="Treatment" name="Treatment" required type="text" placeholder="" value="<?php echo $onsite->Treatment ?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-sm-4 control-label">Medications</label>
                            <div class="col-sm-8">
                              <input autocomplete="off" class="form-control form-white" id="Medications" name="Medications" required type="text" placeholder="" value="<?php echo $onsite->Medications ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-4">
                          ...
                          <div class="form-group">
                            <div class="col-sm-12">
                              <textarea name="Assessment" id="Assessment" rows="5" class="form-control form-white" placeholder="" required><?php echo $onsite->Assessment ?></textarea>
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <div class="col-sm-12">
                              <textarea name="Fitness" id="Fitness" rows="2" class="form-control form-white" placeholder="" required><?php echo $onsite->Fitness ?></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
