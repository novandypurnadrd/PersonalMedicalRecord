        ...
        <div class="page-content">
          ...
          <?php foreach ($OffSite as $offsite): ?>
            <?php foreach ($Patient as $patient): ?>
              ...
              <?php endif; ?>
            <?php endforeach; ?>
            <form class="form-horizontal" method="post" action="<?php echo base_url().'OffSite/Update/UpdateOffSite/'.$id ?>">
            <div class="row">
                  ...
                  <div class="panel-content bg-default">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <div class="prepend-icon">
                                <input autocomplete="off" type="text" id="Date" name="Date" class="b-datepicker form-control form-white" required data-date-format="yyyy-mm-dd" value="<?php echo $offsite->Date ?>">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            <div class="col-sm-12">
                              <textarea name="Diagnose" id="Diagnose" rows="5" class="form-control form-white" placeholder="" required><?php echo $offsite->Diagnose ?></textarea>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            <div class="col-sm-12">
                              <textarea name="Therapy" id="Therapy" rows="5" class="form-control form-white" placeholder="" required><?php echo $offsite->Therapy ?></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
