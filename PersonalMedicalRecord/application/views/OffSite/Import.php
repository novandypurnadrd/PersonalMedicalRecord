    ...
    <section>
      ...
      <div class="main-content">
        ...
        <div class="page-content">
          <div class="header">
            <h2><strong>Import</strong> Off Site</h2>
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                <li><a href="#">Import</a>
                </li>
                <li class="active">OffSite</li>
              </ol>
            </div>
          </div>
          <form class="form-horizontal"  method="post" action="<?php echo base_url().'OffSite/Import/ImportOffSite' ?>" enctype="multipart/form-data">
          <div class="row">
                      ...
                      <div class="col-md-6">
                        <h1>
                          <small>
                            ...
                            <a target="_blank" href="<?php echo base_url()?>excel/template/ImportOffSite.xlsx" class="control-label">Download Template Here <span><i class="fa fa-download" ></i></span></a>
                          </small>
                        </h1>
                      </div>
                    </div>
