									...
									<div class="col-xs-6 col-sm-6">
										...
										<div class="col-xs-6 col-sm-6">
												...
												<div class="form-group">
														...
														<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
															<input type="text" class="form-control" onkeyup="convert()" autocomplete="off" id="price" name="price" value=""/>
														</div>
												</div><!-- /.span -->
												<div class="form-group">
												</br>
														...
														<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
															<input type="number" class="form-control" readonly autocomplete="off" id="total" name="total" placeholder=""/>
														</div>
												</div><!-- /.span -->
												<div class="form-group">
												</br>
														...
														<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
															<span class="input-icon">
																<input type="number" class="form-control" readonly autocomplete="off" id="dollars" name="dollars" placeholder=""/>
