...
<html lang="en">
  ...
  <body class="sidebar-light fixed-topbar theme-sltl bg-light-dark color-blue dashboard">
    ...
    <section>
      ...
      <div class="main-content">
        ...
        <div class="page-content">
          <div class="header">
            <h2><strong>Update</strong> Medical Check Up</h2>
          ...
          <?php foreach ($MCU as $mcu): ?>
            <?php foreach ($Patient as $patient): ?>
              ...
              <?php endif; ?>
            <?php endforeach; ?>
            <form class="form-horizontal" method="post" action="<?php echo base_url().'MCU/Update/UpdateMCU/'.$id ?>">
              <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                <input autocomplete="off" class="form-control form-white" id="Type" name="Type" required type="text" placeholder="" value="<?php echo $mcu->Type ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                <div class="prepend-icon">
                                  <input autocomplete="off" type="text" id="DateMCU" name="DateMCU" class="b-datepicker form-control form-white" required data-date-format="yyyy-mm-dd" value="<?php echo $mcu->DateMCU ?>">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                <div class="prepend-icon">
                                  <input autocomplete="off" type="text" id="DateResult" name="DateResult" class="b-datepicker form-control form-white" required data-date-format="yyyy-mm-dd" value="<?php echo $mcu->DateResult ?>">
                                  <i class="icon-calendar"></i>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                <input autocomplete="off" class="form-control form-white" id="BP" name="BP" required type="text" placeholder="" value="<?php echo $mcu->BP ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-4 control-label">Pulse</label>
                              <div class="col-sm-8">
                                <input autocomplete="off" class="form-control form-white" id="Pulse" name="Pulse" required type="text" placeholder="" value="<?php echo $mcu->Pulse ?>">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                <input autocomplete="off" class="form-control form-white" id="Resp" name="Resp" required type="text" placeholder="" value="<?php echo $mcu->Resp ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-4 control-label">Height</label>
                              <div class="col-sm-8">
                                <input autocomplete="off" class="form-control form-white" id="Height" name="Height" required type="text" placeholder="" value="<?php echo $mcu->Height ?>">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                <input autocomplete="off" class="form-control form-white" id="Weight" name="Weight" required type="text" placeholder="" value="<?php echo $mcu->Weight ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-4 control-label">BMI</label>
                              <div class="col-sm-8">
                                <input autocomplete="off" class="form-control form-white" id="BMI" name="BMI" required type="text" placeholder="" value="<?php echo $mcu->BMI ?>">
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                <input autocomplete="off" class="form-control form-white" id="VOD" name="VOD" required type="text" placeholder="" value="<?php echo $mcu->VOD ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-2 control-label">VOS</label>
                              <div class="col-sm-8">
                                <input autocomplete="off" class="form-control form-white" id="VOS" name="VOS" required type="text" placeholder="" value="<?php echo $mcu->VOS ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-2 control-label">VOD/S</label>
                              <div class="col-sm-8">
                                <input autocomplete="off" class="form-control form-white" id="VODS" name="VODS" required type="text" placeholder="" value="<?php echo $mcu->VODS ?>">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                <textarea name="ColorBlind" id="ColorBlind" rows="2" class="form-control form-white" placeholder="" required><?php echo $mcu->ColorBlind ?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-2 control-label">Eyes</label>
                              <div class="col-sm-8">
                                <textarea name="Eyes" id="Eyes" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->Eyes ?></textarea>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                <textarea name="ENT" id="ENT" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->ENT ?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-3 control-label">Heart</label>
                              <div class="col-sm-9">
                                <textarea name="Heart" id="Heart" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->Heart ?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-3 control-label">Lung</label>
                              <div class="col-sm-9">
                                <textarea name="Lung" id="Lung" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->Lung ?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-3 control-label">Abd</label>
                              <div class="col-sm-9">
                                <textarea name="Abd" id="Abd" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->Abd ?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-3 control-label">Hand</label>
                              <div class="col-sm-9">
                                <textarea name="Hand" id="Hand" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->Hand ?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-3 control-label">Leg</label>
                              <div class="col-sm-9">
                                <textarea name="Leg" id="Leg" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->Leg ?></textarea>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                <textarea name="Paresis" id="Paresis" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->Paresis ?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-3 control-label">Edema</label>
                              <div class="col-sm-9">
                                <textarea name="Edema" id="Edema" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->Edema ?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-3 control-label">Skin</label>
                              <div class="col-sm-9">
                                <textarea name="Skin" id="Skin" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->Skin ?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-3 control-label">Genital</label>
                              <div class="col-sm-9">
                                <textarea name="Genital" id="Genital" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->Genital ?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-3 control-label">Varices</label>
                              <div class="col-sm-9">
                                <textarea name="Varices" id="Varices" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->Varices ?></textarea>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                <textarea name="Audiometry" id="Audiometry" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->Audiometry ?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-3 control-label">Spirometry</label>
                              <div class="col-sm-9">
                                <textarea name="Spirometry" id="Spirometry" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->Spirometry ?></textarea>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                <textarea name="ECG" id="ECG" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->ECG ?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-3 control-label">X-Ray</label>
                              <div class="col-sm-9">
                                <textarea name="XRay" id="XRay" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->XRay ?></textarea>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                <textarea name="Hematology" id="Hematology" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->Hematology ?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-3 control-label">Urinalisis</label>
                              <div class="col-sm-9">
                                <textarea name="Urinalisis" id="Urinalisis" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->Urinalisis ?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-3 control-label">Biokimia</label>
                              <div class="col-sm-9">
                                <textarea name="Biokimia" id="Biokimia" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->Biokimia ?></textarea>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                <textarea name="Serology" id="Serology" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->Serology ?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-3 control-label">Logam Berat</label>
                              <div class="col-sm-9">
                                <textarea name="LogamBerat" id="LogamBerat" rows="4" class="form-control form-white" placeholder="" required><?php echo $mcu->LogamBerat ?></textarea>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                <textarea name="Summary" id="Summary" rows="6" class="form-control form-white" placeholder="" required><?php echo $mcu->Summary ?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                <textarea name="Recommendation" id="Recommendation" rows="6" class="form-control form-white" placeholder="" required><?php echo $mcu->Recommendation ?></textarea>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                <textarea name="NoteDoctor" id="NoteDoctor" rows="6" class="form-control form-white" placeholder="" required><?php echo $mcu->NoteDoctor ?></textarea>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                <textarea name="NoteHR" id="NoteHR" rows="6" class="form-control form-white" placeholder="" required><?php echo $mcu->NoteHR ?></textarea>
                              </div>
                            </div>
                          </div>
                        </div>
    ...
    <script src="<?php echo base_url();?>assets/global/plugins/bootstrap-tags-input/bootstrap-tagsinput.min.js"></script> <!-- Select Updates -->
