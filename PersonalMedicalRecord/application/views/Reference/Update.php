        ...
        <div class="page-content">
          ...
          <?php foreach ($Reference as $reference): ?>
            <?php foreach ($Patient as $patient): ?>
              ...
              <?php endif; ?>
            <?php endforeach; ?>
            <form class="form-horizontal" method="post" action="<?php echo base_url().'Reference/Update/UpdateReference/'.$id ?>">
            <div class="row">
                      ...
                      <div class="row">
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input autocomplete="off" class="form-control" readonly id="NIK" name="NIK" onkeypress="Generator()" required type="text" placeholder="" value="<?php echo $reference->NIK ?>">
                            </div>
                          </div>
                          <div class="form-group">
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="form-group">
                            <label class="col-sm-4 control-label">Date of Reference</label>
                            <div class="col-sm-8">
                              <div class="prepend-icon">
                                <input autocomplete="off" type="text" id="DateReference" name="DateReference" class="b-datepicker form-control form-white" required data-date-format="yyyy-mm-dd" value="<?php echo $reference->DateReference ?>">
            ...
            <div class="row">
              <div class="col-lg-12 portlets">
                <div class="panel">
                  <div class="panel-header panel-controls">
                    <h3><i class="icon-check"></i> <strong>Update</strong> <small>Reference</small></h3>
                  </div>
                  <div class="panel-content bg-default">
                    <div class="row">
                      <div class="col-md-3">
                            ...
                            <div class="form-group">
                              <div class="input-group">
                                <div class="icheck-inline">
                                  <label><input type="radio" name="Status" <?php if($reference->Status == "1"){echo "checked='true'";} ?> data-radio="iradio_square-blue" value="1"> Fit</label>
                                  <label><input type="radio" name="Status" <?php if($reference->Status == "0"){echo "checked='true'";} ?> data-radio="iradio_square-blue" value="0">Currently Unfit</label>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="col-md-9">
                        <div class="form-group">
                          ...
                          <div class="col-sm-11">
                            <input autocomplete="off" class="form-control form-white" id="Purpose" name="Purpose" required type="text" placeholder="" value="<?php echo $reference->Purpose ?>">
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="col-sm-11">
                          ...
                          <div class="col-sm-11">
                            <textarea name="Diagnose" id="Diagnose" rows="3" class="form-control form-white" placeholder="" required><?php echo $reference->Diagnose ?></textarea>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="col-sm-11">
                          ...
                          <div class="col-sm-11">
                            <textarea name="Note" id="Note" rows="3" class="form-control form-white" placeholder="" required><?php echo $reference->Note ?></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
