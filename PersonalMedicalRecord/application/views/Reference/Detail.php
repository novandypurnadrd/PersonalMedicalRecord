          ...
          <?php foreach ($Patient as $patient): ?>
                      ...
                      <div class="row">
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input autocomplete="off" class="form-control" readonly id="NIK" name="NIK" onkeypress="Generator()" required type="text" placeholder="" value="<?php echo $NIK ?>">
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <div class="prepend-icon">
                                <?php foreach ($Reference as $temp): ?>
                                  <?php $DateReference = $temp->DateReference; ?>
                                <?php endforeach; ?>
                                <input autocomplete="off" type="text" id="DateReference" name="DateReference" class="b-datepicker form-control" readonly required data-date-format="yyyy-mm-dd" value="<?php echo $DateReference ?>">
            ...
            <div class="row">
              <div class="col-lg-12 portlets">
                <div class="panel">
                  <div class="panel-header panel-controls">
                    <h3><i class="icon-check"></i> <strong></strong><?php echo $no ?> <small>Referral</small></h3>
                  </div>
                  <div class="panel-content bg-default">
                    <div class="row">
                      <div class="col-md-3">
                        <div class="col-md-12">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <div class="prepend-icon">
                                <input autocomplete="off" type="text" id="Date" name="Date" class="b-datepicker form-control" readonly required data-date-format="yyyy-mm-dd" value="<?php echo $reference->Date ?>">
                                <i class="icon-calendar"></i>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="form-group">
                              <div class="input-group">
                                <div class="icheck-inline">
                                  <label><input type="radio" name="Status<?php echo $no ?>" Disabled <?php if($reference->Status == "1"){echo "checked='true'";} ?> data-radio="iradio_square-blue" value="0"> Fit</label>
                                  <label><input type="radio" name="Status<?php echo $no ?>" Disabled <?php if($reference->Status == "0"){echo "checked='true'";} ?> data-radio="iradio_square-blue" value="1">Currently Unfit</label>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="col-md-9">
                        <div class="form-group">
                          ...
                          <div class="col-sm-11">
                            <input autocomplete="off" class="form-control" readonly id="Purpose" name="Purpose" required type="text" placeholder="" value="<?php echo $reference->Purpose ?>">
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="col-sm-11">
                          ...
                          <div class="col-sm-11">
                            <textarea name="Diagnose" id="Diagnose" rows="3" class="form-control" readonly placeholder="" required><?php echo $reference->Diagnose ?></textarea>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="col-sm-11">
                          ...
                          <div class="col-sm-11">
                            <textarea name="Note" id="Note" rows="3" class="form-control" readonly placeholder="" required><?php echo $reference->Note ?></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
